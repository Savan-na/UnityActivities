...
/*
IMPORTANT: To keep the capsule upright during movement:
1. Select the Player object in the Hierarchy
2. In the Inspector, find the Rigidbody component
3. Under "Constraints", check "Freeze Rotation" for:
   - X (prevents falling forward/backward)
   - Z (prevents falling left/right)
   - Y (prevents rotation from collisions - we control rotation with A/D keys)
*/
